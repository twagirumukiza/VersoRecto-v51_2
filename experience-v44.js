(function(){
  ...
  function importData(file){return file.text().then(t=>{const x=JSON.parse(t);if(!x||x.version!==44||!x.positions)throw new Error('Fichier V44 invalide');save(x);return stats();});}
  ...
  window.VR44Memory={beginGame,recordMove,finishGame,bestMove,stats,exportData,importData,clear,positionKey,markSession};
})();
